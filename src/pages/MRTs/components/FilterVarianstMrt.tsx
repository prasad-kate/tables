...
import {
  citiesList,
  filterTypeTableData as data,
  usStateList,
  type FilterDataPerson,
} from "../data/MrtTableData";

const FilterVariantMrt = () => {
  const columns = useMemo<MRT_ColumnDef<FilterDataPerson>[]>(
    () => [
      {
        header: "Status",
...
const FilterWithVariantsTypeTable = () => (
  //App.tsx or AppProviders file
  <LocalizationProvider dateAdapter={AdapterDayjs}>
    <div className="table-container">
      <Title title="Filter Variants Table" />
      <FilterVariantMrt />
    </div>
  </LocalizationProvider>
);

export default FilterWithVariantsTypeTable;
